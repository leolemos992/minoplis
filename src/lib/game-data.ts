...
export const boardSpaces: (Property | { type: string; name: string, id?:string })[] = [
  ...
  { type: 'community-chest', name: 'Sorte/Azar', id: 'cc1' },
  ...
  { type: 'chance', name: 'Sorte/Azar', id: 'chance1' },
  ...
  { type: 'community-chest', name: 'Sorte/Azar', id: 'cc3' },
  ...
  { type: 'chance', name: 'Sorte/Azar', id: 'chance3' },
